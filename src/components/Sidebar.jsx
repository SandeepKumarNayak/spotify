  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex"> 
      ...
      <div className="h-[85%] bg-[#121212] rounded">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col gap-1 pl-4 justify-start">
            <h1>Create your first playlist</h1>
            <p className="font-light">it&apos;s easy we will help you</p>
            <button className="px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4">Create Playlist</button>
        </div>
        <div className="p-4 bg-[#242424] m-2 mt-4 rounded font-semibold flex flex-col gap-1 pl-4 justify-start">
